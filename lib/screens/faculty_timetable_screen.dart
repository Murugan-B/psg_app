...
class FacultyTimetableScreen extends ConsumerStatefulWidget {
  final bool isEmbedded;
  const FacultyTimetableScreen({super.key, this.isEmbedded = false});

  @override
  ConsumerState<FacultyTimetableScreen> createState() => _FacultyTimetableScreenState();
}

class _FacultyTimetableScreenState extends ConsumerState<FacultyTimetableScreen> {
